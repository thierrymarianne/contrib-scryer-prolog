import * as __wbg_star0 from './snippets/scryer-prolog-006fa47e63bfecda/inline0.js';
...
export class Machine {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Machine.prototype);
        obj.__wbg_ptr = ptr;
        MachineFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
     ...
     */
    consultModuleString(module, program) {
        ...
        const ret = wasm.machine_consultModuleString(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
    ...
    runQuery(query) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.machine_runQuery(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
...
const MachineBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_machinebuilder_free(ptr >>> 0, 1));
/**
...
export class MachineBuilder {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MachineBuilderFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_machinebuilder_free(ptr, 0);
    }
    /**
     * Creates a new `MachineBuilder` with the default configuration.
     */
    constructor() {
        const ret = wasm.machinebuilder_new();
        this.__wbg_ptr = ret >>> 0;
        MachineBuilderFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    build() {
        const ret = wasm.machinebuilder_build(this.__wbg_ptr);
        return Machine.__wrap(ret);
    }
}

const QueryStateFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_querystate_free(ptr >>> 0, 1));
/**
...
export class QueryState {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(QueryState.prototype);
        obj.__wbg_ptr = ptr;
        QueryStateFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        QueryStateFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_querystate_free(ptr, 0);
    }
    /**
     * Drops the query.
     *
     ...
     */
    drop() {
        wasm.querystate_drop(this.__wbg_ptr);
    }
    /**
     ...
     */
    next() {
        const ret = wasm.querystate_next(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_querystate_new = function(arg0) {
        const ret = QueryState.__wrap(arg0);
        return ret;
    };
    ...
    imports['./snippets/scryer-prolog-006fa47e63bfecda/inline0.js'] = __wbg_star0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('scryer_prolog_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

...
1. **Fork and clone:**
   ```bash
   git fork https://github.com/weavingtheweb/scryer-prolog-zenroom
   git clone https://github.com/YOUR-USERNAME/scryer-prolog-zenroom
...
- Check [open issues](https://github.com/weavingtheweb/scryer-prolog-zenroom/issues)

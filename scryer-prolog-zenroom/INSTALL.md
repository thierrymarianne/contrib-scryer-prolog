...
```prolog
dependencies([
    dependency("scryer-prolog-zenroom", git("https://github.com/yourusername/scryer-prolog-zenroom.git"))
]).
```
...
```bash
cd scryer_libs/scryer-prolog-zenroom
...
```prolog
:- use_module(bakage).
:- use_module(pkg('scryer-prolog-zenroom')).
...
```bash
git clone https://github.com/yourusername/scryer-prolog-zenroom.git
...
```bash
sudo mkdir -p /usr/local/lib/scryer-prolog/scryer-prolog-zenroom
sudo cp lib/* /usr/local/lib/scryer-prolog/scryer-prolog-zenroom/
```

**Option B: User-local**

```bash
mkdir -p ~/scryer_libs/scryer-prolog-zenroom
cp lib/* ~/scryer_libs/scryer-prolog-zenroom/
```
...
:- use_module(library('scryer-prolog-zenroom/zenroom')).

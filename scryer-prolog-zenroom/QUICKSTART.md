...
```
scryer-prolog-zenroom/          # Standalone package (ready to distribute)
├── lib/                 # Library modules
...
### Method 1: Git Clone
```bash
git clone https://github.com/weavingtheweb/scryer-prolog-zenroom
cd scryer-prolog-zenroom
./install.sh user
```
...
### Method 2: Tarball
```bash
tar -czf scryer-prolog-zenroom-0.1.0.tar.gz scryer-prolog-zenroom/
# Distribute tarball
tar -xzf scryer-prolog-zenroom-0.1.0.tar.gz
cd scryer-prolog-zenroom
./install.sh user
```

### Method 3: Manual Copy
Just copy the `scryer-prolog-zenroom/` directory anywhere and run `./install.sh`
